# -*- coding: utf-8 -*-
"""Nevaasan_Pyth_lab.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RMRVWRnp8p1gyKF_x9lhXxtIMEf-yANS
"""
...
print(text.upper())
print(text.lower())
text.replace('Available','Not Available')
...
mark04=89
mark05=71
average=(mark01+mark02+mark03+mark04+mark05)/5
print("the average value is",average)
print(type(average))
int(average)

#5 Data structures(List)
name=['Nevas','Swetha','Bharathi','Abinaya','Aarav']
gender=['m','f','m','f','m']
age=[19,22,21,23,22]
register_no=[721,722,723,724,725]
nationality=['I','I','F','I','I']
...
wt_corpa={'hlo':'hello','gnsd':'good night sweet dreams','gr8':'great','idk':'i dont know','tc':'take care',}
print(wt_corpa)
print(wt_corpa.keys())
print(wt_corpa['hlo'])
del(wt_corpa['hlo'])
